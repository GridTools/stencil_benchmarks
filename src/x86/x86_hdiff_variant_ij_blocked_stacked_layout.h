                ...
                for (int jb = 0; jb < m_nbj; ++jb) {
                    for (int ib = 0; ib < m_nbi; ++ib) {
                        for (int k = 0; k < ksize; ++k) {
                            ...
                            int index_lap_tmp = (bn * this->ksize() + 2 * bn * h) * m_kstride_tmp + k * m_kstride_tmp -
                                                m_istride_tmp - m_jstride_tmp;
                            int index_flx_tmp =
                                (bn * this->ksize() + 2 * bn * h) * m_kstride_tmp + k * m_kstride_tmp - m_istride_tmp;
                            int index_fly_tmp =
                                (bn * this->ksize() + 2 * bn * h) * m_kstride_tmp + k * m_kstride_tmp - m_jstride_tmp;
...
#pragma omp simd
                                for (int i = 0; i < imax + 1; ++i) {
                                    ...
                                    if (flx[index_flx_tmp] * (in[index_flx_tmp + m_istride_tmp] - in[index_flx_tmp]) >
                                        0)
                                        flx[index_flx_tmp] = 0.;
...
#pragma omp simd
                                for (int i = 0; i < imax; ++i) {
                                    ...
                                    if (fly[index_fly_tmp] * (in[index_fly_tmp + m_jstride_tmp] - in[index_fly_tmp]) >
                                        0)
                                        fly[index_fly_tmp] = 0.;
...
#pragma omp simd
                                for (int i = 0; i < imax; ++i) {
                                    out[index_out] = in[index_out_tmp] -
                                                     coeff[index_out_tmp] *
