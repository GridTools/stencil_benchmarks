...
namespace platform {
    ...
    namespace x86 {
        ...
        class x86_fast_waves_uv_variant_ij_blocked final
            : public x86_fast_waves_uv_stencil_variant<Platform, ValueType> {
          public:
            using value_type = ValueType;

            x86_fast_waves_uv_variant_ij_blocked(const arguments_map &args)
                : x86_fast_waves_uv_stencil_variant<Platform, ValueType>(args),
            ...
            void fast_waves_uv() override {
                ...
                auto computePPGradCor = [&](int i, int j, int k) {
                    fppgradcor[this->index(i, j, k)] =
                        fwgtfac[this->index(i, j, k)] * fppuv[this->index(i, j, k)] +
                    ...
                    for (int ib = 0; ib < isize + 1; ib += m_iblocksize) {
                        ...
                        for (k = cFlatLimit + 1; k < ksize; ++k) {
                            for (int i = ib; i < imax; ++i) {
                                for (int j = jb; j < jmax; ++j) {
                                    computePPGradCor(i, j, k);
                                    fppgradcor[this->index(i, j, k - 1)] =
                                        (fppgradcor[this->index(i, j, k)] - fppgradcor[this->index(i, j, k - 1)]);
                                }
                            }
                        }
                    }
...
#pragma omp parallel for collapse(2)
                for (int jb = 0; jb < jsize; jb += m_jblocksize) {
                    for (int ib = 0; ib < isize; ib += m_iblocksize) {
                        ...
                        for (int i = ib - 1; i < imax; ++i) {
                            for (int j = jb; j < jmax + 1; ++j) {
                                fxrhsx[this->index(i, j, k)] =
                                    -ffx[this->index(i, j, k)] /
                                        ((ValueType)0.5 *
                                            (frho[this->index(i, j, k)] + frho[this->index(i + 1, j, k)])) *
                                        (fppuv[this->index(i + 1, j, k)] - fppuv[this->index(i, j, k)]) +
                                    futensstage[this->index(i, j, k)];
                                fxrhsy[this->index(i, j, k)] =
                                    -edadlat / ((ValueType)0.5 *
                                                   (frho[this->index(i, j + 1, k)] + frho[this->index(i, j, k)])) *
                                        (fppuv[this->index(i, j + 1, k)] - fppuv[this->index(i, j, k)]) +
                        ...
                        for (int i = ib; i < imax + 1; ++i) {
                            for (int j = jb; j < jmax + 1; ++j) {
                                fxrhsz[this->index(i, j, k)] =
                                    frho0[this->index(i, j, k)] / frho[this->index(i, j, k)] * 9.8 *
                                        ((ValueType)1.0 -
                                            fcwp[this->index(i, j, k)] *
                                                (fp0[this->index(i, j, k)] + fppuv[this->index(i, j, k)])) +
                    ...
                    for (int jb = 0; jb < jsize; jb += m_jblocksize) {
                        for (int ib = 0; ib < isize; ib += m_iblocksize) {
                            ...
                            for (int i = ib; i < imax; ++i) {
                                for (int j = jb; j < jmax; ++j) {
                                    if (k < cFlatLimit) {
                                        fppgradu[this->index(i, j, k)] =
                                            (fppuv[this->index(i + 1, j, k)] - fppuv[this->index(i, j, k)]);
                                        fppgradv[this->index(i, j, k)] =
                                            (fppuv[this->index(i, j + 1, k)] - fppuv[this->index(i, j, k)]);
                                    } else {
                                        fppgradu[this->index(i, j, k)] =
                                            (fppuv[this->index(i + 1, j, k)] - fppuv[this->index(i, j, k)]) +
                                            (fppgradcor[this->index(i + 1, j, k)] + fppgradcor[this->index(i, j, k)]) *
                                                (ValueType)0.5 *
                                                ((fhhl[this->index(i, j, k + 1)] + fhhl[this->index(i, j, k)]) -
                                                    (fhhl[this->index(i + 1, j, k + 1)] +
                                                        fhhl[this->index(i + 1, j, k)])) /
                                                ((fhhl[this->index(i, j, k + 1)] - fhhl[this->index(i, j, k)]) +
                                                    (fhhl[this->index(i + 1, j, k + 1)] -
                                                        fhhl[this->index(i + 1, j, k)]));
                                        fppgradv[this->index(i, j, k)] =
                                            (fppuv[this->index(i, j + 1, k)] - fppuv[this->index(i, j, k)]) +
                                            (fppgradcor[this->index(i, j + 1, k)] + fppgradcor[this->index(i, j, k)]) *
                                                (ValueType)0.5 *
                                                ((fhhl[this->index(i, j, k + 1)] + fhhl[this->index(i, j, k)]) -
                                                    (fhhl[this->index(i, j + 1, k + 1)] +
                                                        fhhl[this->index(i, j + 1, k)])) /
                                                ((fhhl[this->index(i, j, k + 1)] - fhhl[this->index(i, j, k)]) +
                                                    (fhhl[this->index(i, j + 1, k + 1)] -
                                                        fhhl[this->index(i, j + 1, k)]));
                                    }
                            ...
                            for (int i = ib; i < imax; ++i) {
                                for (int j = jb; j < jmax; ++j) {
                                    ValueType rhou = ffx[this->index(i, j, k)] /
                                                     ((ValueType)0.5 *
                                                         (frho[this->index(i + 1, j, k)] + frho[this->index(i, j, k)]));
                                    ValueType rhov = edadlat / ((ValueType)0.5 * (frho[this->index(i, j + 1, k)] +
                                                                                     frho[this->index(i, j, k)]));

                                    frefUField[this->index(i, j, k)] =
                                        fupos[this->index(i, j, k)] +
                                        (futensstage[this->index(i, j, k)] - fppgradu[this->index(i, j, k)] * rhou) *
                                            dt_small;
                                    frefVField[this->index(i, j, k)] =
                                        fvpos[this->index(i, j, k)] +
                                        (fvtensstage[this->index(i, j, k)] - fppgradv[this->index(i, j, k)] * rhov) *
                                            dt_small;
                                }
                            }
                        }
                ...
                for (int jb = 0; jb < jsize; jb += m_jblocksize) {
                    for (int ib = 0; ib < isize; ib += m_iblocksize) {
                        ...
                        for (int i = ib; i < imax; ++i) {
                            for (int j = jb; j < jmax; ++j) {
                                ValueType bottU =
                                    fxlhsx[this->index(i, j, k)] * fxdzdx[this->index(i, j, k)] *
                                        ((ValueType)0.5 *
                                                (fxrhsz[this->index(i + 1, j, k)] + fxrhsz[this->index(i, j, k)]) -
                                            fxdzdx[this->index(i, j, k)] * fxrhsx[this->index(i, j, k)] -
                                            (ValueType)0.5 * ((ValueType)0.5 * (fxdzdy[this->index(i + 1, j - 1, k)] +
                                                                                   fxdzdy[this->index(i + 1, j, k)]) +
                                                                 (ValueType)0.5 * (fxdzdy[this->index(i, j - 1, k)] +
                                                                                      fxdzdy[this->index(i, j, k)])) *
                                                (ValueType)0.5 *
                                                ((ValueType)0.5 * (fxrhsy[this->index(i + 1, j - 1, k)] +
                                                                      fxrhsy[this->index(i + 1, j, k)]) +
                                                    (ValueType)0.5 * (fxrhsy[this->index(i, j - 1, k)] +
                                                                         fxrhsy[this->index(i, j, k)]))) +
                                    fxrhsx[this->index(i, j, k)];
                                frefUField[this->index(i, j, k)] = fupos[this->index(i, j, k)] + bottU * dt_small;
                                ValueType bottV =
                                    fxlhsy[this->index(i, j, k)] * fxdzdy[this->index(i, j, k)] *
                                        ((ValueType)0.5 *
                                                (fxrhsz[this->index(i, j + 1, k)] + fxrhsz[this->index(i, j, k)]) -
                                            fxdzdy[this->index(i, j, k)] * fxrhsy[this->index(i, j, k)] -
                                            (ValueType)0.5 * ((ValueType)0.5 * (fxdzdx[this->index(i - 1, j + 1, k)] +
                                                                                   fxdzdx[this->index(i, j + 1, k)]) +
                                                                 (ValueType)0.5 * (fxdzdx[this->index(i - 1, j, k)] +
                                                                                      fxdzdx[this->index(i, j, k)])) *
                                                (ValueType)0.5 *
                                                ((ValueType)0.5 * (fxrhsx[this->index(i - 1, j + 1, k)] +
                                                                      fxrhsx[this->index(i, j + 1, k)]) +
                                                    (ValueType)0.5 * (fxrhsx[this->index(i - 1, j, k)] +
                                                                         fxrhsx[this->index(i, j, k)]))) +
                                    fxrhsy[this->index(i, j, k)];
