...
namespace platform {
    ...
    namespace knl {
        ...
        template class variant_1d_nontemporal<flat, float>;
        template class variant_1d_nontemporal<flat, double>;
        template class variant_1d_nontemporal<cache, float>;
        template class variant_1d_nontemporal<cache, double>;
