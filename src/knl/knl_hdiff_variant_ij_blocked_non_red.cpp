...
namespace platform {
    ...
    namespace knl {
        ...
        void hdiff_variant_ij_blocked_non_red<ValueType>::hdiff() {
...
#pragma omp simd
        ...
        template class hdiff_variant_ij_blocked_non_red<float>;
        template class hdiff_variant_ij_blocked_non_red<double>;
