...
namespace platform {
    ...
    namespace knl {
        ...
        class hdiff_variant_ij_blocked_non_red final : public knl_hdiff_stencil_variant<ValueType> {
          public:
        ...
        extern template class hdiff_variant_ij_blocked_non_red<float>;
        extern template class hdiff_variant_ij_blocked_non_red<double>;
