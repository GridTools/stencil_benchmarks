...
namespace platform {
    ...
    namespace knl {
        ...
        void vadv_variant_ij_blocked_split<ValueType>::vadv() {
...
#pragma omp simd
        ...
        template class vadv_variant_ij_blocked_split<float>;
        template class vadv_variant_ij_blocked_split<double>;
