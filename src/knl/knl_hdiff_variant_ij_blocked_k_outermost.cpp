...
namespace platform {
    ...
    namespace knl {
        ...
        void hdiff_variant_ij_blocked_k_outermost<ValueType>::hdiff() {
...
#pragma vector nontemporal
        ...
        template class hdiff_variant_ij_blocked_k_outermost<float>;
        template class hdiff_variant_ij_blocked_k_outermost<double>;
