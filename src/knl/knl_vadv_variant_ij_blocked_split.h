...
namespace platform {
    ...
    namespace knl {
        ...
        class vadv_variant_ij_blocked_split final : public knl_vadv_stencil_variant<ValueType> {
          public:
        ...
        extern template class vadv_variant_ij_blocked_split<float>;
        extern template class vadv_variant_ij_blocked_split<double>;
