...
namespace platform {
    ...
    namespace knl {
        ...
        class hdiff_variant_ij_blocked_k_innermost final : public knl_hdiff_stencil_variant<ValueType> {
          public:
        ...
        extern template class hdiff_variant_ij_blocked_k_innermost<float>;
        extern template class hdiff_variant_ij_blocked_k_innermost<double>;
