...
namespace platform {
    ...
    namespace knl {
        ...
        class vadv_variant_ij_blocked_colopt final : public knl_vadv_stencil_variant<ValueType> {
          public:
...
#pragma omp declare simd linear(i) uniform( \
    j, ishift, jshift, ccol, wcon, ustage, upos, utens, utensstage, isize, jsize, ksize, istride, jstride, kstride)
        ...
        extern template class vadv_variant_ij_blocked_colopt<float>;
        extern template class vadv_variant_ij_blocked_colopt<double>;
