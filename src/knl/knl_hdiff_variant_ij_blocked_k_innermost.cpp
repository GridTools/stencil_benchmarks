...
namespace platform {
    ...
    namespace knl {
        ...
        void hdiff_variant_ij_blocked_k_innermost<ValueType>::hdiff() {
...
#pragma vector nontemporal
        ...
        template class hdiff_variant_ij_blocked_k_innermost<float>;
        template class hdiff_variant_ij_blocked_k_innermost<double>;
